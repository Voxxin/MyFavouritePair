...
public enum MFPArmorMaterials implements ArmorMaterial {
    ...
    LEATHER_COPPER("heavy_leather_boots", 4, new int[]{3, 2, 3, 1}, 15, SoundEvents.ITEM_ARMOR_EQUIP_LEATHER,
            0.0F, 0.0F, () ->
         Ingredient.ofItems(Items.LEATHER_BOOTS, Items.COPPER_INGOT)),
    LEATHER_RABBIT_HIDE("light_leather_boots", 5, new int[]{2, 2, 3, 1}, 15,
            SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, 0.0F, 0.0F, () ->
